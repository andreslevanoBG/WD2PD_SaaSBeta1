		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Users Run Integrations",
									"targetURL": "#RunIntegrationPlanningUsers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RunIntegrationPlanningUsers-display": {
								"semanticObject": "RunIntegrationPlanningUsers",
								"action": "display",
								"description": "Users Run Integrations",
								"title": "Users Run Integrations",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.RunIntegrationPlanningUsers",
									"url": sap.ui.require.toUrl("shapein/RunIntegrationPlanningUsers")
								}
							}
						}
					}
