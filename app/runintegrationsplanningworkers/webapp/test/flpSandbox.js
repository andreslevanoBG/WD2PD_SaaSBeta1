		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Workers Run Integrations",
									"targetURL": "#RunIntegrationPlanningWorkers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RunIntegrationPlanningWorkers-display": {
								"semanticObject": "RunIntegrationPlanningWorkers",
								"action": "display",
								"description": "Workers Run Integrations",
								"title": "Workers Run Integrations",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.RunIntegrationPlanningWorkers",
									"url": sap.ui.require.toUrl("shapein/RunIntegrationPlanningWorkers")
								}
							}
						}
					}
