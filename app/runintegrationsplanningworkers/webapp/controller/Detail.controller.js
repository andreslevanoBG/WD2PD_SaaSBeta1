sap.ui.define([
	...
	return BaseController.extend("shapein.RunIntegrationPlanningWorkers.controller.Detail", {
		...
		//	}
			...
			var fragmentName2 = "shapein.RunIntegrationPlanningWorkers.view.fragment." + sFragmentName2;
	...
	//		}
		...
		handleSavePress: function (oEvent) {
			...
			var text = "Are you sure you want to update a Workers Planning Adata?";
			var that = this;
		...
		onAddPlanD: function () {
			...
			if (!this.byId("PlanningD")) {
				Fragment.load({
					...
					name: "shapein.RunIntegrationPlanningWorkers.view.fragment.Planning",
					controller: this
