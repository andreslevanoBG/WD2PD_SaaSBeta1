sap.ui.define([
    ...
    return BaseController.extend("shapein.MonitoringOrganizations.controller.Detail", {
            ...
            oModel.read(sPath, {
                ...
                success: function (oData, oResponse) {
                    ...
                    results.forEach(function (entry) {
                        ...
                        //		var corpname = objectValue['corporate_name'];
        ...
        onAction: function (oEvent) {
            ...
            var text = "Are you sure you want to reprocess Organization ";
            text = text + org + "?";
            var that = this;
                        ...
                        if (that.getOwnerComponent().settings) {
                            ...
                            $.ajax(settings).done(function (data, textStatus, jqXHR) {
                                ...
                                if (textStatus == "success") {
                                    ...
                                    var texto = "Organization " + org + " reprocessed.";
        ...
        onActionRepro: function (oEvent) {
            ...
            var text = "Are you sure you want to reprocess Organizations in this Integration Process?";
            //	text = text + worker + "?";
            var that = this;
            var mappings = this.getOwnerComponent().oMappings;
            var dialog = new sap.m.Dialog({
