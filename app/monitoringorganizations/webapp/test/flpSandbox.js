		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitoring Organizations",
									"targetURL": "#MonitoringOrganizations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MonitoringOrganizations-display": {
								"semanticObject": "MonitoringOrganizations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.MonitoringOrganizations",
									"url": sap.ui.require.toUrl("shapein/MonitoringOrganizations")
								}
							}
						}
					}
