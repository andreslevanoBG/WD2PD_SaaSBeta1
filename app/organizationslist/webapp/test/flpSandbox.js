		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#OrganizationsList-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"OrganizationsList-display": {
								"semanticObject": "OrganizationsList",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.OrganizationsList",
									"url": sap.ui.require.toUrl("shapein/OrganizationsList")
								}
							}
						}
					}
