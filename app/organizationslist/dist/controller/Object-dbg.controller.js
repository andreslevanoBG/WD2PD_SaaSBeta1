sap.ui.define([
	...
	return BaseController.extend("shapein.OrganizationsList.controller.Object", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("Organizations", {
					uuid: sObjectId
				});
		...
		_onBindingChange: function () {
			...
			this.addHistoryEntry({
				...
				intent: "#OrganizationsList-display&/Organizations/" + sObjectId
			});
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialogDetail")) {
				Fragment.load({
					...
					name: "shapein.OrganizationsList.view.ViewSettingsDialogDetail",
					controller: this
