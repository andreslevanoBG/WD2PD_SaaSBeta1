		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#UsersMonitoring-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UsersMonitoring-display": {
								"semanticObject": "UsersMonitoring",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.UsersMonitoring",
									"url": sap.ui.require.toUrl("shapein/UsersMonitoring")
								}
							}
						}
					}
