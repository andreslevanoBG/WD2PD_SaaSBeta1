sap.ui.define([
	...
	return BaseController.extend("shapein.UsersMonitoring.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				...
				this._oListFilterState.aSearch.push(new Filter("pck_code", FilterOperator.EQ, "SYN_USER"));
			} else {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "shapein.UsersMonitoring.view.ViewSettingsDialog",
					controller: this
		...
		onOpenFilterSettings: function (oEvent) {
			...
			if (!this.byId("viewFiltersDialog")) {
				Fragment.load({
					id: this.getView().getId(),
					name: "shapein.UsersMonitoring.view.FiltersDialog",
					controller: this
				}).then(function (oDialog) {
					// connect dialog to the root view of this component (models, lifecycle)
					this.getView().addDependent(oDialog);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilters.push(new Filter([
				new Filter("pck_code", FilterOperator.EQ, "SYN_USER")
			], true));
