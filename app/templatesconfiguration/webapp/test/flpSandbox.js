		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Templates",
									"targetURL": "#Worker-TemplateConfig"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Worker-TemplateConfig": {
								"semanticObject": "Worker",
								"action": "TemplateConfig",
								"description": "App Templates Configuration",
								"title": "Templates",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.TemplatesConfiguration",
									"url": sap.ui.require.toUrl("shapein/TemplatesConfiguration")
								}
							}
						}
					}
