		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#MonitoringWorkers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MonitoringWorkers-display": {
								"semanticObject": "MonitoringWorkers",
								"action": "display",
								"description": "App Monitoring Workers",
								"title": "Monitoring Workers",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.MonitoringWorkers",
									"url": sap.ui.require.toUrl("shapein/MonitoringWorkers")
								}
							}
						}
					}
