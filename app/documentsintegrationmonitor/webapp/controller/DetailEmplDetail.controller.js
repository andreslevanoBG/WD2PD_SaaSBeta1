sap.ui.define([
    ...
    return BaseController.extend("shapein.DocumentsIntegrationMonitor.controller.DetailEmplDetail", {
        ...
        onListUpdateFinished: function (oEvent) {
            ...
            if (this.byId("lineItemsListEmpl").getBinding("itemsEmpl").isLengthFinal()) {
                if (iTotalItems) {
        ...
        _onMetadataLoaded: function () {
            ...
            var iOriginalViewBusyDelay = this.getView().getBusyIndicatorDelay(),
                oViewModel = this.getModel("detailDetailView"),
                oLineItemTable = this.byId("lineItemsListEmpl"),
        ...
        _applyFilterSearch: function () {
            ...
            this.getView().byId("lineItemsListEmpl").getBinding("items").filter(aFilters, "Application");
        ...
        onFilterSelect: function (oEvent) {
            var oBinding = this.getView().byId("lineItemsListEmpl").getBinding("itemsEmpl"),
        ...
        handleCancel: function () {
            var vLayout = this.byId("viewSettingsDialogDetailDetEmpl").getFilterItems()[0].getCustomControl();
            var oCustomFilter = this.byId("viewSettingsDialogDetailDetEmpl").getFilterItems()[0],
            ...
            var vLayout2 = this.byId("viewSettingsDialogDetailDetEmpl").getFilterItems()[1].getCustomControl();
            var oCustomFilter2 = this.byId("viewSettingsDialogDetailDetEmpl").getFilterItems()[1],
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialogDetailDetEmpl")) {
                ...
                this.byId("viewSettingsDialogDetailDetEmpl").open(sDialogTab);
            }
        },
        _applySortGroup: function (item, desc) {
            ...
            var binding = this.getView().byId("lineItemsListEmpl").getBinding("itemsEmpl");
