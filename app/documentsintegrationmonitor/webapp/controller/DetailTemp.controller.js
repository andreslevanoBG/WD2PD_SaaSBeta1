sap.ui.define([
    ...
    return BaseController.extend("shapein.DocumentsIntegrationMonitor.controller.DetailTemp", {
        ...
        onInit: function () {
            ...
            this.getRouter().getRoute("objecttemp").attachPatternMatched(this._onObjectMatched, this);
        ...
        _onObjectMatched: function (oEvent) {
            ...
            this.getModel().metadataLoaded().then(function () {
                var sObjectPath = this.getModel().createKey("Di_Template", {
                    uuid: sObjectId
                });
        ...
        _onBindingChange: function () {
            ...
            oModel.read(sPath, {
                urlParameters: {
                    "$expand": "employee_template/employee/worker"
                },
                success: function (oData, oResponse) {
                    var Results = oData.employee_template.results;
                    //var tempResults = oData.template;
                    //var emplResults = oData.employee;
                    var scount = 0;
                    var ecount = 0;
                    that.reprocesses = [];
                    oViewModel.setProperty("/busy", false);
        ...
        searchFilters: function () {
            var aFilterItems = [],
                aFilters = [],
                aCaptions = [];
            if (this.byId("viewSettingsDialogDetailTemp")) {
                aFilterItems = this.byId("viewSettingsDialogDetailTemp").getFilterItems();

                var vLayout = this.byId("viewSettingsDialogDetailTemp").getFilterItems()[0].getCustomControl();
                ...
                var vLayout2 = this.byId("viewSettingsDialogDetailTemp").getFilterItems()[1].getCustomControl();
                ...
                var sortItems = this.byId("viewSettingsDialogDetailTemp").getSortItems();
                var sortItem;
                ...
                var sortDesc = this.byId("viewSettingsDialogDetailTemp").getSortDescending();
            }
            ...
            if (query !== "") {
                aFilters.push(new Filter([
                    new Filter("employee/worker/employee_number", FilterOperator.Contains, query),
                    new Filter("employee/worker/lastname", FilterOperator.Contains, query),
                    new Filter("employee/worker/firstname", FilterOperator.Contains, query)
                ], false));
            }
        ...
        handleCancel: function () {
            var vLayout = this.byId("viewSettingsDialogDetailTemp").getFilterItems()[0].getCustomControl();
            var oCustomFilter = this.byId("viewSettingsDialogDetailTemp").getFilterItems()[0],
            ...
            var vLayout2 = this.byId("viewSettingsDialogDetailTemp").getFilterItems()[1].getCustomControl();
            var oCustomFilter2 = this.byId("viewSettingsDialogDetailTemp").getFilterItems()[1],
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialogDetailTemp")) {
                Fragment.load({
                    ...
                    name: "shapein.DocumentsIntegrationMonitor.view.ViewSettingsDialogDetailTemp",
                    controller: this
                ...
                this.byId("viewSettingsDialogDetailTemp").open(sDialogTab);
            }
        },
        ...
        _showDetailTempDet: function (oItem) {
            ...
            this.getRouter().navTo("detailTempDetail", {
                ...
                employee: oItem.mAggregations.cells[4].getProperty("text"),
                template: oItem.mAggregations.cells[5].getProperty("text")
            }, bReplace);
        },
