		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Documents Integration Monitor",
									"targetURL": "#DocumentsIntegrationMonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DocumentsIntegrationMonitor-display": {
								"semanticObject": "DocumentsIntegrationMonitor",
								"action": "display",
								"description": "Documents Integration Monitor",
								"title": "Documents Integration Monitor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shapein.DocumentsIntegrationMonitor",
									"url": sap.ui.require.toUrl("shapein/DocumentsIntegrationMonitor")
								}
							}
						}
					}
