sap.ui.define([
	"sap/ui/test/Opa5",
	"shapein/DocumentsIntegrationMonitor/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("shapein.DocumentsIntegrationMonitor.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "shapein.DocumentsIntegrationMonitor",
					async: true
				},
				hash: oOptions.hash,
