sap.ui.define([
	"sap/ui/test/Opa5",
	"shapein/RunIntegrationPlanningOrganizations/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"shapein/RunIntegrationPlanningOrganizations/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("shapein.RunIntegrationPlanningOrganizations.test.integration.arrangements.Startup", {
